...
LUA_SHA1 = get_hash(os.path.join(CWD, 'metaadlibrary.lua'))
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/8/80/Meta-icon.png/800px-Meta-icon.png" height="50px" title=""/>
        <h2>Meta Ad Library <span class="links"><a href="https://www.facebook.com/ads/library/">Website</a> &middot; <a href="https://tracker.archiveteam.org/metaadlibrary/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Meta_Ad_Library">Wiki</a></span></h2>
        <p>Archiving the Meta Ad Library.</p>
    '''
)
