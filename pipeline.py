...
project = Project(
    ...
    project_html='''
        ...
        <h2>Meta Ad Library <span class="links"><a href="https://www.facebook.com/ads/library/">Website</a> &middot; <a href="http://tracker.archiveteam.org/metaadlibrary/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Meta_Ad_Library">Wiki</a></span></h2>
